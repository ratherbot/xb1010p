...
<body class = "auto opac register-block">
    <img class="my-main-cover" src="img/main_page.png">
    <section class = "registration-block">
        ...
        <form method="post">
            ...
            <div class = "black-button translucent slide-bottom slide-top">
                <input class = "email-form" id="password" name="password" type="password" placeholder="Пароль">
            </div>
