...
<header class = "header">
    <nav class="navigation">
        <ul class = "navigation-topics">
            ...
            <li>
                <a class = "search refs" href = "search.php">
...
----->          <img class="normal-cover" src="img/main_page.png">
            </div>
            <?php if (!check_auth()): ?>
        ...
        <section class = "instructing-section">
            <ul class = "instructing-cards">
                ...
                <li class = "instructing-card">
                    ...
                    <p>Читатели могут оценивать ваши посты по шкале от 1 до 10 , а также оставлять комментарии</p>
                </li>
                <li class = "instructing-card">
                    <h2>Шаг 3</h2>
                    <h3>Отслеживайте рейтинги</h3>
                    <p>В зависимости от самой оценки и их количества рейтинг вашего профиля будет меняться по шкале от 1 до 10, что влияет на приоритет поиска и на место в списке на главной странице</p>
                </li>
            </ul>
    ...
    Перейти в блог
        ...
        <div class = "sections hidden">
            ...
            <ul class = "sections-list">
                ...
                <li>
                    <a class = "section underline refs" href = "rating.php">
                ...
                <li>
                    <a class = "section refs" href = "profile.php">
                        <img src = "img/user-icon.svg">
                        <p>Профиль</p>
                    </a>
                </li>
                <li>
                    <a class="section underline refs" href = "favourite.php">
